...
export function parseApiToForm<T extends Record<string, any>>(obj: T): T {
...
export function parseFormToApi<T extends Record<string, any>>(obj: T): T {
  const copy: Record<string, any> = { ...obj };
