...
import { getSystemStatistics, getAuditLogs, getAuditStats, getComprehensiveReport, listUsers, createUser as apiCreateUser, updateUser as apiUpdateUser, deactivateUser as apiDeactivateUser, activateUser as apiActivateUser } from '@services/apiService';
const initialState = {
...
export const fetchAuditLogs = createAsyncThunk('superAdmin/fetchAuditLogs', async (params) => {
...
export const fetchUsers = createAsyncThunk('superAdmin/fetchUsers', async (params) => {
    return await listUsers(params);
});
export const createUser = createAsyncThunk('superAdmin/createUser', async (payload) => {
    return await apiCreateUser(payload);
});
export const updateUser = createAsyncThunk('superAdmin/updateUser', async ({ id, payload }) => {
    return await apiUpdateUser(id, payload);
});
export const deactivateUser = createAsyncThunk('superAdmin/deactivateUser', async (id) => {
    return await apiDeactivateUser(id);
});
export const activateUser = createAsyncThunk('superAdmin/activateUser', async (id) => {
